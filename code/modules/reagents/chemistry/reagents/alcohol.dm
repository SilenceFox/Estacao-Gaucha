...
/datum/reagent/consumable/ethanol/cachaca
	name = "Cachaça"
	id = "cachaca"
	description = "Um derivado do Rum criado no Brasil, muito usado no famoso coquetel 'Caipirinha'."
	nutriment_factor = 1 * REAGENTS_METABOLISM
	color = "#664300" // rgb: 102, 67, 0
	alcohol_perc = 0.4
	drink_icon ="cachacaglass"
	drink_name = "Cachaça Glass"
	drink_desc = "Um doce gole da bebida tradicional brasileira."
	taste_description = "cachaça"

/datum/reagent/consumable/ethanol/caipirinha
	name = "Caipirinha"
	id = "caipirinha"
	description = "Um coquetel tradicional brasileiro."
	nutriment_factor = 1 * REAGENTS_METABOLISM
	color = "#664300" // rgb: 102, 67, 0
	alcohol_perc = 0.4
	drink_icon ="caipirinhaglass"
	drink_name = "Caipirinha Glass"
	drink_desc = "Um doce gole da bebida tradicional brasileira.Voce quase consegue ver cristo redentor depois de dar um gole!"
	taste_description = "caipirinha"
